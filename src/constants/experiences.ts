export const experiences = [
	{
		name: 'React Developer at Evold',
		type: 'Part time',
		description: `Discovered and got familiar with the Agile working methodology, worked on 3 projects where I honed my skills as a software developer by implementing new features from scratch in collaboration with cross-functional teams, proposing solutions to existing problems and suggesting possible and beneficial improvements.`,
		from: 'Aug 2021',
		to: 'Jun 2022',
		location: 'Morocco (Remote)'
	},
	{
		name: 'Angular Developer at AcmePixel',
		type: 'Contract',
		description: `During a three-month contract, I worked on two projects where I demonstrated high adaptability by quickly integrating into existing workflows and learning new technologies. My role focused on enhancing existing features and fixing bugs to improve overall functionality and user experience.`,
		from: 'Jun 2022',
		to: 'Sep 2022',
		location: 'Germany (Remote)'
	},
	{
		name: 'Team Lead Full Stack Developer at Evold',
		type: 'Part time',
		description: `
			<p>Worked as a team lead on one big project where I was responsible for handling the entire development lifecycle from design to deployment using mainly Angular in the frontend and NodeJS in the backend.</p>
			<br>
			<ul>
